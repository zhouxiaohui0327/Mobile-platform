...
<!--            <h3 class="title">合作模式</h3>-->
<!--            <ul class="cooperation list-unstyled clearfix">-->
<!--                <li>-->
<!--                    <h4>付费推广</h4>-->
...
<!--                    </div>-->
<!--                    <p class="btns">-->
<!--                        <a href="" class="btn btn-success" title="查看">查看</a>-->
<!--                        <a href="" class="btn btn-primary" title="加入">加入</a>-->
<!--                    </p>-->
<!--                </li>-->
<!--                <li>-->
<!--                    <h4>换量推广</h4>-->
...
<!--                <li>-->
<!--                    <h4>搜索分成</h4>-->
<!--                    <img src="images/icon_ssfc.png" alt=""/>-->
<!--                    <div class="info">-->
<!--                        <p>为网站提供移动搜索功能</p>-->
<!--                        <p>让您获得丰厚的搜索分成</p>-->
<!--                        <p>实现移动互联网流量变现</p>-->
